...
# 
# Secondary magnetic fields are simulated over conductive sphere in a vacuum. The sphere has a conductivity of $\sigma$ = 1 S/m. The center of the sphere is located at (0,0,-50) and has a radius of $a$ = 8 m. The background conductivity is defined as 1e-8 S/m. 
# 
...
# If desired, we can export the data to a basic text file.
